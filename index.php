...
if(count(check_requirements()))
    print_R(check_requirements());
...
{
    if($ambient == "publicado")
    {
        set_include_path('/ag904/core/');
    }
    else
    {
        //set_include_path('/dados/www/core/');
        //set_include_path('/dados/www/core/');
    }
}
else
...
{
// VirtualQMOD
    //require_once('H:/samuel/xamp/htdocs/ag904/cliente1/vqmod/vqmod.php');
...
$sql = "SELECT * FROM `" . DB_PREFIX . "setting` WHERE store_id = '" . (int)$config->get('config_store_id') . "' ORDER BY store_id ASC";
