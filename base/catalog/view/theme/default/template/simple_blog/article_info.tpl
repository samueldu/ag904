    ...
    <script type="text/javascript">		
			$('#button-comment').bind('click', function() {
				$.ajax({
					...
					dataType: 'json',
					data: $("#form-review").serialize()+'&reply_id=' + encodeURIComponent($('input[name=\'blog_article_reply_id\']').val()),
				//	data: 'name=' + encodeURIComponent($('input[name=\'name\']').val()) + '&text=' + encodeURIComponent($('textarea[name=\'text\']').val()) + '&g-recaptcha-response=' + encodeURIComponent($('input[name=\'g-recaptcha-response\']').val()) + '&reply_id=' + encodeURIComponent($('input[name=\'blog_article_reply_id\']').val()),
					beforeSend: function() {
