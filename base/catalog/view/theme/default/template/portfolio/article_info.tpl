<?php echo $header; ?>
    <div class="container">
        ...
        <div class="form-group">
			...
			<?php
print "<pre>";
			print_r($article_additional_description);
print "</pre>";
			?>
			...
			<div class="article-thumbnail-image">
				<img src="<?php echo $gallery[$key]['image']; ?>" alt="<?php echo $gallery[$key]['article_title']; ?>" />
                                                    <span class="article-description">
                                                        <?php echo $gallery[$key]['description']; ?>
                                                    </span>
			</div>
			<?php
                                    }
                    ...
                    <?php if(isset($article_info_found)) { ?>
                        <div class="article-info">
    						<div class="article-title">
								...
								<BR><h1><?php echo $article_info['sub_title']; ?><h1>
    						</div>
                            ...
                            <div class="article-sub-title">
    							...
    							<?php if((isset($portfolio_share_social_site)) && ($portfolio_share_social_site)) { ?>
                            ...
                            <?php if(($portfolio_related_articles) && ($related_articles)) { ?>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
    ...
    <script type="text/javascript">
		...
		$('#comment-list').load('index.php?route=portfolio/article/comment&portfolio_article_id=<?php echo $portfolio_article_id; ?>');
    ...
    <script type="text/javascript">		
			$('#button-comment').bind('click', function() {
				$.ajax({
					type: 'POST',
					url: 'index.php?route=portfolio/article/writeComment&portfolio_article_id=<?php echo $portfolio_article_id; ?>',
					dataType: 'json',
