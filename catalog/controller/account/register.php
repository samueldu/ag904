...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['customer_group_id']) or isset($this->request->post['customer_group_id']) && is_array($this->config->get('config_customer_group_display')) && in_array($this->request->post['customer_group_id'], $this->config->get('config_customer_group_display'))) {
		...
		if (is_array($this->config->get('config_customer_group_display'))) {
			...
			foreach ($customer_groups as $customer_group) {
				if (in_array($customer_group['customer_group_id'], $customer_group_id)) {
		...
		*/
		...
		if (isset($this->request->post['customer_group_id']) or isset($this->request->get['customer_group_id'])) {
			if(isset($this->request->get['customer_group_id']))
