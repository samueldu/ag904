      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-web-payment-software" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="maxipago_merchant_name" value="<?php echo $maxipago_merchant_name; ?>" placeholder="<?php echo $entry_login; ?>" id="input-login" class="form-control" />
              <?php if ($error_login) { ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="maxipago_merchant_key" value="<?php echo $maxipago_merchant_key; ?>" placeholder="<?php echo $entry_key; ?>" id="input-key" class="form-control" />
              <?php if ($error_key) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="maxipago_mode" id="input-mode" class="form-control">
                <?php if ($maxipago_mode == 'live') { ?>
                <option value="live" selected="selected"><?php echo $text_live; ?></option>
                <?php } else { ?>
                <option value="live"><?php echo $text_live; ?></option>
                <?php } ?>
                <?php if ($maxipago_mode == 'test') { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="maxipago_method" id="input-method" class="form-control">
                <?php if ($maxipago_method == 'authorization') { ?>
                ...
                <?php } ?>
                <?php if ($maxipago_method == 'capture') { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="maxipago_total" value="<?php echo $maxipago_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_order_status; ?></label>
            <div class="col-sm-10">
              <select name="maxipago_order_status_id" id="input-order-status" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $maxipago_order_status_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="maxipago_sort_order" value="<?php echo $maxipago_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
        </form>
      </div>
