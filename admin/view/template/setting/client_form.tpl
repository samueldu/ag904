      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
          <ul class="nav nav-tabs">
              <li class="active">
            <a href="#tab-client" data-toggle="tab"><?php echo $tab_client; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab-client">
              ...
              <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-nome-contato"><?php echo $entry_nome_contato; ?></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_nome_contato" value="<?php echo $config_nome_contato; ?>" placeholder="<?php echo $entry_nome_contato; ?>" id="input-name" class="form-control" />
                        <?php if ($error_nome_contato) { ?>
                        <div class="text-danger"><?php echo $error_nome_contato; ?></div>
                        <?php } ?>
                    </div>
                </div>

                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-nome-contato"><?php echo $entry_documento; ?></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_documento" value="<?php echo $config_documento; ?>" placeholder="<?php echo $entry_documento; ?>" id="input-name" class="form-control" />
                        <?php if ($error_documento) { ?>
                        <div class="text-danger"><?php echo $error_documento; ?></div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tab-database">
              ...
              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-user"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_prod_user); ?>"><?php echo $entry_prod_user; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_prod_user" value="<?php echo $config_prod_user; ?>" placeholder="<?php echo $entry_prod_user; ?>" id="input-user" class="form-control" />
                      <?php if ($error_prod_user) { ?>
                      <div class="text-danger"><?php echo $error_prod_user; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-host"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_prod_host); ?>"><?php echo $entry_prod_host; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_prod_host" value="<?php echo $config_prod_host; ?>" placeholder="<?php echo $entry_prod_host; ?>" id="input-host" class="form-control" />
                      <?php if ($error_prod_host) { ?>
                      <div class="text-danger"><?php echo $error_prod_host; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-pass"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_prod_pass); ?>"><?php echo $entry_prod_pass; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_prod_pass" value="<?php echo $config_prod_pass; ?>" placeholder="<?php echo $entry_prod_pass; ?>" id="input-pass" class="form-control" />
                      <?php if ($error_prod_pass) { ?>
                      <div class="text-danger"><?php echo $error_prod_pass; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-base"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_prod_base); ?>"><?php echo $entry_prod_base; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_prod_base" value="<?php echo $config_prod_base; ?>" placeholder="<?php echo $entry_prod_base; ?>" id="input-base" class="form-control" />
                      <?php if ($error_prod_base) { ?>
                      <div class="text-danger"><?php echo $error_prod_base; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-dev-user"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_dev_user); ?>"><?php echo $entry_dev_user; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_dev_user" value="<?php echo $config_dev_user; ?>" placeholder="<?php echo $entry_dev_user; ?>" id="input-user" class="form-control" />
                      <?php if ($error_dev_user) { ?>
                      <div class="text-danger"><?php echo $error_dev_user; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-dev-host"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_dev_host); ?>"><?php echo $entry_dev_host; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_dev_host" value="<?php echo $config_dev_host; ?>" placeholder="<?php echo $entry_dev_host; ?>" id="input-host" class="form-control" />
                      <?php if ($error_dev_host) { ?>
                      <div class="text-danger"><?php echo $error_dev_host; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-pass"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_dev_pass); ?>"><?php echo $entry_dev_pass; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_dev_pass" value="<?php echo $config_dev_pass; ?>" placeholder="<?php echo $entry_dev_pass; ?>" id="input-dev-pass" class="form-control" />
                      <?php if ($error_dev_pass) { ?>
                      <div class="text-danger"><?php echo $error_dev_pass; ?></div>
                      <?php } ?>
                  </div>
              </div>

              <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-base"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_dev_base); ?>"><?php echo $entry_dev_base; ?></span></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_dev_base" value="<?php echo $config_dev_base; ?>" placeholder="<?php echo $entry_dev_base; ?>" id="input-dev-base" class="form-control" />
                      <?php if ($error_dev_base) { ?>
                      <div class="text-danger"><?php echo $error_dev_base; ?></div>
                      <?php } ?>
                  </div>
              </div>
            ...
            <div class="tab-pane" id="tab-general">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-url"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_prod_url); ?>"><?php echo $entry_prod_url; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_prod_url" value="<?php echo $config_prod_url; ?>" placeholder="<?php echo $entry_prod_url; ?>" id="input-url" class="form-control" />
                  <?php if ($error_prod_url) { ?>
                  <div class="text-danger"><?php echo $error_prod_url; ?></div>
                  <?php } ?>
                </div>
              </div>
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-url-dev"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_url); ?>"><?php echo $entry_dev_url; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_dev_url" value="<?php echo $config_dev_url; ?>" placeholder="<?php echo $entry_dev_url; ?>" id="input-url-dev" class="form-control" />
                        <?php if ($error_dev_url) { ?>
                        <div class="text-danger"><?php echo $error_dev_url; ?></div>
                        <?php } ?>
                    </div>
                </div>
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-path"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_prod_path); ?>"><?php echo $entry_prod_path; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_prod_path" value="<?php echo $config_prod_path; ?>" placeholder="<?php echo $entry_prod_path; ?>" id="input-path" class="form-control" />
                        <?php if ($error_prod_path) { ?>
                        <div class="text-danger"><?php echo $error_prod_path; ?></div>
                        <?php } ?>
                    </div>
                </div>
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-path-dev"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_path); ?>"><?php echo $entry_dev_path; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_dev_path" value="<?php echo $config_dev_path; ?>" placeholder="<?php echo $entry_dev_path; ?>" id="input-path-dev" class="form-control" />
                        <?php if ($error_path_dev) { ?>
                        <div class="text-danger"><?php echo $error_dev_path; ?></div>
                        <?php } ?>
                    </div>
                </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ssl"><span data-toggle="tooltip" data-html="true" title="<?php echo $help_prod_ssl; ?>"><?php echo $entry_prod_ssl; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_prod_ssl" value="<?php echo $config_prod_ssl; ?>" placeholder="<?php echo $entry_prod_ssl; ?>" id="input-ssl" class="form-control" />
                </div>
              </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-ssl_dev"><span data-toggle="tooltip" data-html="true" title="<?php echo $help_dev_ssl; ?>"><?php echo $entry_dev_ssl; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_dev_ssl" value="<?php echo $config_dev_ssl; ?>" placeholder="<?php echo $entry_dev_ssl; ?>" id="input-ssl_dev" class="form-control" />
                    </div>
                </div>
                </div>
            </div>
