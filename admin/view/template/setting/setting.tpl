        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                <legend><?php echo $text_parcelamento; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-return"><span data-toggle="tooltip" title="<?php echo $help_return; ?>">
                      <?php echo "Quantidade parcelas"; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_parcelamento_nparcelas" value="<?php echo $config_parcelamento_nparcelas; ?>" placeholder="" id="input-parcelamento-nparcelas" class="form-control" />
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-return"><span data-toggle="tooltip" title="<?php echo $help_return; ?>">
                      <?php echo "Juros"; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_parcelamento_juros" value="<?php echo $config_parcelamento_juros; ?>" placeholder="" id="input-parcelamento-juros" class="form-control" />
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-return"><span data-toggle="tooltip" title="<?php echo $help_return; ?>">
                      <?php echo "Parcela mínima"; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_parcelamento_minima" value="<?php echo $config_parcelamento_minima; ?>" placeholder="" id="input-parcelamento-minima" class="form-control" />
                  </div>
                </div>
