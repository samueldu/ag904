<?php echo $header; ?>
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog-article" class="form-horizontal">
                        ...
                        <ul class="nav nav-tabs">
							...
							<li><a href="#tab-add-description" data-toggle="tab"><?php echo $entry_additional_description; ?></a></li>
                        ...
                        <div class="tab-content">
                                 ...
                                 <div class="tab-content">
                                    <?php foreach ($languages as $language) { ?>
                                        <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                            ...
                                            <div class="form-group required">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><span data-toggle="tooltip" title="<?php echo $help_title; ?>"><?php echo $entry_sub_title; ?></label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <input type="text" name="article_description[<?php echo $language['language_id']; ?>][sub_title]" value="<?php echo isset($article_description[$language['language_id']]['sub_title']) ? $article_description[$language['language_id']]['sub_title'] : ''; ?>" class="form-control" />
                                                    <?php if (isset($error_article_title[$language['language_id']])) { ?>
                                                    <span class="text-danger"><?php echo $error_article_title[$language['language_id']]; ?></span>
                                                    <?php } ?>
                                                </div>
                                            ...
                                            <div class="form-group required">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_short_description; ?></label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <textarea name="article_description[<?php echo $language['language_id']; ?>][short_description]" id="description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($article_description[$language['language_id']]['short_description']) ? $article_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                                                    <?php if (isset($error_description[$language['language_id']])) { ?>
                                                    <span class="text-danger"><?php echo $error_description[$language['language_id']]; ?></span>
                                                    <?php } ?>
                                                </div>
                            ...
                            <div class="tab-pane" id="tab-data">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_url; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_gallery; ?></label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <select name="gallery_id" class="form-control">
                                            <option value="" <?php if(!is_numeric($gallery_id)) { echo "selected='selected'"; } ?>><?php echo $text_disabled; ?></option>
											<?php foreach($banners as $key=>$value) { ?>
												<option value="<?=$banners[$key]['banner_id']?>" <?php if($banners[$key]['banner_id'] == $gallery_id) { echo "selected='selected'"; } ?>><?php echo $banners[$key]['name']; ?></option>
											<?php } ?>
                                        </select>
									</div>
                                </div>
													...
													<td class="text-left">
														<?php foreach ($languages as $language) { ?>
															<div class="input-group">
																...
																<input type="text" class="form-control" placeholder="Título" name="article_addition_description[<?php echo $module_row ?>][<?php echo $language['language_id']; ?>][title]" value="<?php if(isset($additional_description[$language['language_id']]['title'])) { echo $additional_description[$language['language_id']]['title']; } else { echo ""; } ?>" />
																
																<input type="text" class="form-control" placeholder="Subtítulo" name="article_addition_description[<?php echo $module_row ?>][<?php echo $language['language_id']; ?>][sub_title]" value="<?php if(isset($additional_description[$language['language_id']]['sub_title'])) { echo $additional_description[$language['language_id']]['sub_title']; } else { echo ""; }  ?>" />
																<input type="text" class="form-control" placeholder="Ordem" name="article_addition_description[<?php echo $module_row ?>][<?php echo $language['language_id']; ?>][sort_order]" value="<?php if(isset($additional_description[$language['language_id']]['sort_order'])) { echo $additional_description[$language['language_id']]['sort_order']; } else { echo ""; }  ?>" />
																<textarea rows="5" placeholder="Texto" name="article_addition_description[<?php echo $module_row ?>][<?php echo $language['language_id']; ?>][additional]" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" class="form-control"><?php if(isset($additional_description[$language['language_id']]['additional'])) {echo $additional_description[$language['language_id']]['additional'];} else { echo ""; }  ?></textarea>
															</div>
	        	 										<?php } ?>
													</td>
													<td class="text-center">
														<button type="button" onclick="$('#additional-description<?php echo $module_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
													</td>
												</tr>
											<?php $module_row++; ?>
											<?php } ?>
                            ...
                            <div class="tab-pane" id="tab-option">
                                ...
                                <input type="hidden" name="portfolio_author_id" value="<?php echo $portfolio_author_id; ?>" />
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <div class="well well-sm" style="height: 150px; overflow: auto; margin-bottom:0;">
                                            <?php foreach ($categories as $category) { ?>
                                                <div class="checkbox">
                                                    <label>
                                                        <?php if (in_array($category['portfolio_category_id'], $article_category)) { ?>
        							                    	<input type="checkbox" name="article_category[]" value="<?php echo $category['portfolio_category_id']; ?>" checked="checked" />
        							                    	<?php echo $category['name']; ?>
        							                    <?php } else { ?>
        								                    <input type="checkbox" name="article_category[]" value="<?php echo $category['portfolio_category_id']; ?>" />
        								                    <?php echo $category['name']; ?>
        							                    <?php } ?>
                                                    </label>
                                                </div>
                                        ...
                                        <tbody id="article-row<?php echo $article_row; ?>">
        									<tr>
        										<td class="text-left">
        											...
        											<input type="hidden" name="blog_related_articles[<?php echo $article_row; ?>][portfolio_article_related_id]" value="<?php echo $related_articles['portfolio_article_related_id']; ?>" />
        										</td>										
        										<td class="text-left">
    ...
    <script type="text/javascript">
        ...
        $('input[name=\'author_name\']').autocomplete({
        	'source': function(request, response) {
        		$.ajax({
                    url: 'index.php?route=portfolio/author/autocomplete&token=<?php echo $token; ?>&author_name=' +  encodeURIComponent(request),
        			dataType: 'json',
        			success: function(json) {
        				response($.map(json, function(item) {
        					return {
        						label: item['name'],
        						value: item['portfolio_author_id']
        					}
        				}));
        			}
        		});
        	...
        	'select': function(item) {
                ...
                $('input[name=\'portfolio_author_id\']').val(item['value']);
        	}
        });    
    ...
    <script type="text/javascript">
        ...
        function addDescription() {
            ...
            <?php foreach ($languages as $language) { ?>
				...
				html += '<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /></span>';
                html += '<input type="text" class="form-control" placeholder="Título" name="article_addition_description[' + module_row + '][<?php echo $language['language_id']; ?>][title]" />';
                html += '<input type="text" class="form-control" placeholder="Subtítulo" name="article_addition_description[' + module_row + '][<?php echo $language['language_id']; ?>][sub_title]" />';
                html += '<input type="text" class="form-control" placeholder="Ordem" name="article_addition_description[' + module_row + '][<?php echo $language['language_id']; ?>][sort_order]" />';
				html += '<textarea rows="5" placeholder="Texto" name="article_addition_description[' + module_row + '][<?php echo $language['language_id']; ?>][additional]" id="description-' + module_row + '-<?php echo $language['language_id']; ?>" class="form-control"></textarea> ';
				html += '</div>';
            <?php } ?>
            html += '</td>';
    ...
    <script type="text/javascript">
		...
		function addArticles() {
			...
			html += '	<tr>';
			html += '		<td class="text-left">';
			html += '			<input type="text" name="blog_related_articles[' + article_row + '][article_title]" value="" id="article-title-' + article_row + '" onkeyup="getArticles(' + article_row + ', this.value);" class="form-control" /> <input type="hidden" name="blog_related_articles[' + article_row + '][portfolio_article_related_id]" value="0" />';
			html += '		</td>';			
			html += '		<td class="text-left">';
    ...
    <script type="text/javascript">
        function getArticles(article_row, value) {
            $('input[name=\'blog_related_articles[' + article_row + '][article_title]\']').autocomplete({
            	'source': function(request, response) {
            		$.ajax({
                        url: 'index.php?route=portfolio/article/autocomplete_article&token=<?php echo $token; ?>&portfolio_article_id=<?php echo $portfolio_article_id; ?>&filter_name=' +  encodeURIComponent(request),
            			dataType: 'json',
            			success: function(json) {
            				response($.map(json, function(item) {
            					return {
            						label: item['article_title'],
            						value: item['portfolio_article_id']
            					}
            				}));
            			}
            		});
            	...
            	'select': function(item) {
					...
					$('input[name=\'blog_related_articles[' + article_row + '][portfolio_article_related_id]\']').val(item['value']);
            	}
            });    
        }
    </script>
