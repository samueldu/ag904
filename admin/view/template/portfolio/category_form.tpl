                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        ...
                                        <select name="parent_id" class="form-control">
                      						...
                      						<?php foreach ($categories as $category) { ?>
                      							<?php if ($category['portfolio_category_id'] == $parent_id) { ?>
                      								<option value="<?php echo $category['portfolio_category_id']; ?>" selected="selected"><?php echo $category['name']; ?></option>
                      							<?php } else { ?>
                      								<option value="<?php echo $category['portfolio_category_id']; ?>"><?php echo $category['name']; ?></option>
                      							<?php } ?>
                      						<?php } ?>
                    					</select>
