			          			        ...
			          			        <?php foreach($articles as $article) { ?>
                                            <tr>
                                                <td class="text-center">
                                                    <?php if (in_array($article['portfolio_article_id'], $selected)) { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $article['portfolio_article_id']; ?>" checked="checked" />
                                                    <?php } else { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $article['portfolio_article_id']; ?>" />
                                                    <?php } ?>
                                                </td>
