			          			        ...
			          			        <?php foreach($authors as $author) { ?>
                                            <tr>
                                                <td class="text-center">
                                                    <?php if (in_array($author['portfolio_author_id'], $selected)) { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $author['portfolio_author_id']; ?>" checked="checked" />
                                                    <?php } else { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $author['portfolio_author_id']; ?>" />
                                                    <?php } ?>
                                                </td>
