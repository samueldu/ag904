                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-simple-blog" class="form-horizontal">    
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="simple_blog_limit" value="<?php echo $simple_blog_limit; ?>" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="simple_blog_meta_desc" value="<?php echo $simple_blog_meta_desc; ?>" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input type="text" name="simple_blog_meta_key" value="<?php echo $simple_blog_meta_key; ?>" class="form-control" />
                            </div>
                        </div>
