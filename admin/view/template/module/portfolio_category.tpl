<?php echo $header; ?>
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-simple-blog-category" class="form-horizontal">    
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <select name="portfolio_category_status" class="form-control">
                                    <option value="1" <?php if($portfolio_category_status == 1) { echo "selected='selected'"; } ?>><?php echo $text_enabled; ?></option>
    								<option value="0" <?php if($portfolio_category_status == 0) { echo "selected='selected'"; } ?>><?php echo $text_disabled; ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="checkbox-inline">
                                    <?php if($portfolio_category_search_article) { ?>
    	    							<input type="radio" name="portfolio_category_search_article" value="1" checked="checked" /> <?php echo $text_enabled; ?>&nbsp;
    	    							<input type="radio" name="portfolio_category_search_article" value="0" /> <?php echo $text_disabled; ?>
    	    						<?php } else { ?>
    	    							<input type="radio" name="portfolio_category_search_article" value="1" /> <?php echo $text_enabled; ?>&nbsp;
    	    							<input type="radio" name="portfolio_category_search_article" value="0" checked="checked" /> <?php echo $text_disabled; ?>
    	    						<?php } ?>
                                </div>
                            </div>
                        </div>   
                                    ...
                                    <?php foreach ($modules as $module) { ?>
                                        <div class="tab-pane" id="tab-module<?php echo $module['key']; ?>">
                                            ...
                                            <div class="form-group">
												<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_status; ?></label>
												<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
													<select name="portfolio_category_module[<?php echo $module['key']; ?>][status]" class="form-control">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
													<input type="text" name="portfolio_category_module[<?php echo $module['key']; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="form-control" />
												</div>
											</div>
    ...
    <script type="text/javascript">
		...
		function addModule() {
            ...
            html += '           <select name="portfolio_category_module[' + token + '][status]" class="form-control">';
            ...
            html += '       <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">';
            html += '           <input type="text" name="portfolio_category_module[' + token + '][sort_order]" value="" class="form-control" />';
            html += '       </div>';
            html += '   </div>';
