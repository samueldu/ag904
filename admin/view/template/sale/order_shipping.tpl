...
<link href="<?=BASE_URL_ADMIN?>view/javascript/bootstrap/css/bootstrap.css" rel="stylesheet" media="all" />
...
<link type="text/css" href="<?=BASE_URL_ADMIN?>view/stylesheet/stylesheet.css" rel="stylesheet" media="all" />
</head>
<body>
<div class="container">
