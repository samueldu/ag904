...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-blog-article" data-toggle="tooltip" title="<?php echo $button_save; ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog-article"
                      class="form-horizontal">

                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?></a></li>
                        <li><a href="#tab-data" data-toggle="tab"><?php echo $tab_data; ?></a></li>
                        <li><a href="#tab-add-description"
                               data-toggle="tab"><?php echo $entry_additional_description; ?></a></li>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group required">
                                        <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><span
                                                    data-toggle="tooltip"
                                                    title="<?php echo $help_title; ?>"><?php echo $entry_title; ?></label>

                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <input type="text"
                                                   name="article_description[<?php echo $language['language_id']; ?>][article_title]"
                                                   value="<?php echo isset($article_description[$language['language_id']]['article_title']) ? $article_description[$language['language_id']]['article_title'] : ''; ?>"
                                                   class="form-control"/>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <textarea
                                                    ...
                                                    class="form-control"><?php echo isset($article_description[$language['language_id']]['description']) ? $article_description[$language['language_id']]['description'] : ''; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <textarea
                                                    ...
                                                    class="form-control"><?php echo isset($article_description[$language['language_id']]['meta_description']) ? $article_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <textarea
                                                    ...
                                                    class="form-control"><?php echo isset($article_description[$language['language_id']]['meta_keyword']) ? $article_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail">
                                        <img src="<?php echo $thumb2; ?>" alt="" title=""
                        ...
                        <div class="tab-pane" id="tab-add-description">

                            <style type="text/css">
                                #additional tbody tr td .input-group {
                                    margin-bottom: 10px;
                                }

                                #additional tbody tr td .input-group:last-child {
                                    margin-bottom: 0px;
                                }
                            </style>
                            ...
                            <div class="table-responsive">
                                <table id="additional" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr id="additional-description<?php echo $module_row; ?>">
                                        <td class="text-left">
                                            <?php foreach ($languages as $language) { ?>
                                            <div class="input-group">
                                                ...
                                                <textarea rows="5" placeholder="Texto"
                                                          name="article_addition_description[<?php echo $module_row ?>][<?php echo $language['language_id']; ?>][additional]"
                                                          id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"
                                                          class="form-control"><?php if(isset($additional_description[$language['language_id']]['additional'])) {echo $additional_description[$language['language_id']]['additional'];} else { echo ""; }  ?></textarea>
                                            </div>
                                            <?php } ?>
                                        </td>
                                        <td class="text-center">
                                            <button type="button"
                                                    onclick="$('#additional-description<?php echo $module_row; ?>').remove();"
                                    ...
                                    <tr>
                                        <td></td>
                                        <td class="text-center">
                                            <button type="button" onclick="addDescription();" data-toggle="tooltip"
                                                    title="<?php echo $button_add_description; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <select name="allow_comment" class="form-control">
                                        <option value="1"
                                        <?php if($allow_comment == 1) { echo "selected='selected'"; } ?>
                                        ><?php echo $text_yes; ?></option>
                                        <option value="0"
                                        <?php if($allow_comment == 0) { echo "selected='selected'"; } ?>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <input type="text" name="author_name" value="<?php echo $author_name; ?>"
                                           class="form-control"/>
                                    <input type="hidden" name="simple_blog_author_id"
                                           value="<?php echo $simple_blog_author_id; ?>"/>
                                    ...
                                    <div class="well well-sm" style="height: 150px; overflow: auto; margin-bottom:0;">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <input type="checkbox" name="article_category[]"
                                                       value="<?php echo $category['simple_blog_category_id']; ?>"
                                                       checked="checked"/>
                                    ...
                                    <div class="well well-sm" style="height: 150px; overflow: auto; margin-bottom:0;">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <input type="checkbox" name="article_store[]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <select name="status" class="form-control">
                                        <option value="1"
                                        <?php if($status == 1) { echo "selected='selected'"; } ?>
                                        ><?php echo $text_enabled; ?></option>
                                        <option value="0"
                                        <?php if($status == 0) { echo "selected='selected'"; } ?>
                                        ><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <!-- end of tab-option id -->
                        ...
                        <div class="tab-pane" id="tab-related">
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><span
                                            data-toggle="tooltip"
                                            title="<?php echo $help_article_related_method; ?>"><?php echo $entry_article_related_method; ?></label>

                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <select name="related_article" onchange="getRelatedMethod(this.value);"
                                            class="form-control">
                                        <option value="category_wise"
                                        <?php if($related_article == 'category_wise') { echo "selected='selected'"; } ?>
                                        ><?php echo $entry_category_wise; ?></option>
                                        <option value="manufacturer_wise"
                                        <?php if($related_article == 'manufacturer_wise') { echo "selected='selected'"; } ?>
                                        ><?php echo $entry_manufacturer_wise; ?></option>
                                        <option value="product_wise"
                                        <?php if($related_article == 'product_wise') { echo "selected='selected'"; } ?>
                                        ><?php echo $entry_product_wise; ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="category-wise" style="display:none">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="well well-sm" style="height: 150px; overflow: auto; margin-bottom:0;">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="category_wise[]"
                                                       value="<?php echo $category['category_id']; ?>" <?php if(isset($category_ids)) { for($i=0; $i<count($category_ids); $i++) { if($category_ids[$i] == $category['category_id']) { echo "checked='checked'"; } } } ?>
                                                />
                                                <?php echo $category['name']; ?>
                                            </label>
                                        </div>
                            ...
                            <div class="form-group" id="manufacturer-wise" style="display:none">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="well well-sm" style="height: 150px; overflow: auto; margin-bottom:0;">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="manufacturer_wise[]"
                                                       value="<?php echo $manufacturer['manufacturer_id']; ?>" <?php if(isset($manufacturer_ids)) { for($i=0; $i<count($manufacturer_ids); $i++) { if($manufacturer_ids[$i] == $manufacturer['manufacturer_id']) { echo "checked='checked'"; } } } ?>
                                                />
                            ...
                            <div class="form-group" id="product-wise" style="display:inherit">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    ...
                                    <div id="product-wise-list" class="well well-sm"
                                         style="height: 150px; overflow: auto; margin-bottom:0;">
                                        <?php if(isset($products)) { ?>
                                        <?php foreach($products as $product) { ?>
                                        <div id="product-wise-list<?php echo $product['product_id']; ?>"><i
                                                    class="fa fa-minus-circle"></i> <?php echo $product['name']; ?>
                                            <input type="hidden" name="product_wise[]"
                            ...
                            <table id="related-article" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    <td class="text-left"><span data-toggle="tooltip"
                                                                title="<?php echo $help_related_article_name; ?>"><?php echo $entry_related_article_name; ?>
                                    </td>
                                ...
                                <tr>
                                    <td class="text-left">
                                        <input type="text"
                                               name="blog_related_articles[<?php echo $article_row; ?>][article_title]"
                                               value="<?php echo $related_articles['article_title']; ?>"
                                               id="article-title-<?php echo $article_row; ?>"
                                               onkeyup="getArticles(<?php echo $article_row; ?>, this.value);"
                                               class="form-control"/>
                                        <input type="hidden"
                                               name="blog_related_articles[<?php echo $article_row; ?>][simple_blog_article_related_id]"
                                               value="<?php echo $related_articles['simple_blog_article_related_id']; ?>"/>
                                    </td>
                                    <td class="text-left">
                                        <input type="text"
                                               name="blog_related_articles[<?php echo $article_row; ?>][sort_order]"
                                               value="<?php echo $related_articles['sort_order']; ?>"
                                               class="form-control"/>
                                    </td>
                                    <td class="left">
                                    ...
                                    <td class="text-left">
                                        <button type="button"
                                                onclick="$('#article-row<?php echo $article_row; ?>').remove();"
                                                data-toggle="tooltip" title="<?php echo $button_remove; ?>"
                                                class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td class="text-left">
                                        <button type="button" onclick="addArticles();" data-toggle="tooltip"
                                                title="<?php echo $button_add_articles; ?>" class="btn btn-primary"><i
    ...
    <script type="text/javascript">
        ...
        <?php
        if (isset($banners) and is_array($banners)){
            foreach($languages as $language)
            {
                ...
                $('#description<?php echo $language['language_id']; ?>').summernote({
                    ...
                    oninit: function () {
                        ...
                        var noteBtn = '<button id="gallery-btn<?php echo $language['language_id']; ?>" data-toggle="dropdown" type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="Galeria de imagens" data-event="something" tabindex="-1">' +
                        ...
                        {
                            ?>
                            '<li><a class="button<?php echo $language['language_id']; ?>" data-event="" href="#" data-value="<?=$banners[$key]['banner_id']?>"><?php echo $banners[$key]['name']; ?></a></li>' +
                            <?php
                        }
                        ?>
                        '</ul>';

                        var fileGroup = '<div class="note-height btn-group">' + noteBtn + '</div>';
                        $(fileGroup).appendTo($('#language<?php echo $language['language_id']; ?> .note-toolbar'
                        ))
                        ;
                        // Button tooltips
                        $('#gallery-btn<?php echo $language['language_id']; ?>'
                        ).
                        tooltip({
                            container: 'body',
                            placement: 'bottom'
                        ...
                        $('.button<?php echo $language['language_id']; ?>'
                        ).
                        click(function (event) {
                            insertTextAtCursor('{galeria: '+$(this).data("value")+', colunas:3}');
    ...
    <script type="text/javascript">
        ...
        function addDescription() {
            ...
            html = '<tr id="additional-description' + module_row + '">';
            html += '<td class="text-left">';
        <?php foreach($languages as $language)
            {
                ?>
                html += '<div class="input-group">';
                html += '<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['
                image
                ']; ?>" title="<?php echo $language['
                name
                ']; ?>" align="top" /></span>';
                html += '<textarea rows="5" placeholder="Texto" name="article_addition_description[' + module_row + '][<?php echo $language['
                language_id
                ']; ?>][additional]" id="description-' + module_row + '-<?php echo $language['
                language_id
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            <?php
            } else if ($related_article == 'category_wise') {
                ?>
                $("#category-wise").css({display: "inherit"});
                $("#manufacturer-wise").css({display: "none"});
                $("#product-wise").css({display: "none"});
            <?php
            } else if ($related_article == 'manufacturer_wise') {
                ?>
                $("#category-wise").css({display: "none"});
