              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($badge['id'], $product_badges)) { ?>
                        <input type="checkbox" name="product_badges[]" value="<?php echo $badge['id']; ?>" checked="checked" />
                        <?php echo $badge['text']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="product_badges[]" value="<?php echo $badge['id']; ?>" />
                        <?php echo $badge['text']; ?>
                        <?php } ?>
                      </label>
                    </div>
