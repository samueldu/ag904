...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $export; ?>" data-toggle="tooltip" title="<?php echo $button_export; ?>" class="btn btn-default"><i class="fa fa-share-square-o fa-lg"></i></a>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($newsletter['id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $newsletter['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $newsletter['id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $newsletter['email']; ?></td>
                  <td class="text-left"><?php echo $newsletter['id']; ?></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=marketing/lt_newsletter&token=<?php echo $token; ?>';
