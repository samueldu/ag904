...
class ModelCommonHeader extends Model {
	...
	public function getClient($id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "clients WHERE id = '" . $id . "'");
	...
	{
		$sql = "SELECT * FROM " . DB_PREFIX . "clients inner join " . DB_PREFIX . "store_to_client on " . DB_PREFIX . "clients.id = " . DB_PREFIX . "store_to_client.id_client and " . DB_PREFIX . "store_to_client.id_store = '0'";
