...
class ModelDesignBanner extends Model {
	public function addBanner($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', type_id='".$this->request->get['type_id']."'");
	...
	public function getType($type_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "banner_type WHERE language_id = '" . $this->config->get('config_language_id') . "' and type_id = '".$type_id."'");
	...
	public function getBanners($data = array()) {
		...
		if(!isset($this->request->get['type_id']))
			...
			$filter = "where " . DB_PREFIX . "banner.type_id='".$this->request->get['type_id']."'";

		$sql = "SELECT * FROM " . DB_PREFIX . "banner ".$filter;
	...
	public function getTotalBanners() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "banner where type_id='".$this->request->get['type_id']."'");
