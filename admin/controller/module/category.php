...
class ControllerModuleCategory extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['status'])) {
			$data['status'] = $this->request->post['sstatus'];
		...
		if (isset($this->request->post['category_main'])) {
			$data['category_main'] = $this->request->post['category_main'];
		} elseif (!empty($module_info)) {
			$data['category_main'] = $module_info['category_main'];
		} else {
