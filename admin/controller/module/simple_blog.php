       ...
       public function index() {
		...
		public function getData() {
            ...
            */
			...
			$data['simple_blog_meta_desc'] = '';
			$data['simple_blog_meta_key'] = '';
			...
			if (isset($this->request->post['simple_blog_meta_desc'])) {
				$data['simple_blog_meta_desc'] = $this->request->post['simple_blog_meta_desc'];
			} else if ($this->config->get('simple_blog_meta_desc')) {
				$data['simple_blog_meta_desc'] = $this->config->get('simple_blog_meta_desc');
			}

			if (isset($this->request->post['simple_blog_meta_key'])) {
				$data['simple_blog_meta_key'] = $this->request->post['simple_blog_meta_key'];
			} else if ($this->config->get('simple_blog_meta_key')) {
				$data['simple_blog_meta_key'] = $this->config->get('simple_blog_meta_key');
			}
			...
			if (isset($this->request->post['simple_blog_limit'])) {
				$data['simple_blog_limit'] = $this->request->post['blog_image'];
			} else {
				$data['simple_blog_limit'] = $this->config->get('simple_blog_limit');
			}
