...
class ControllerDesignBanner extends Controller {
	...
	public function getBannerTitle()
	{
		...
		if(!isset($this->request->get['type_id']))
			$this->request->get['type_id'] = 1;

		return $this->model_design_banner->getType($this->request->get['type_id']);
	}

	public function index() {
		$this->load->language('design/banner');

		$this->document->setTitle($this->getBannerTitle());
	...
	protected function getList() {
		...
		$data['heading_title'] = $this->getBannerTitle();
		...
		$pagination->url = $this->url->link('design/banner', 'token=' . $this->session->data['token'] . $url . '&page={page}&type_id='.$this->request->get['type_id'], 'SSL');
