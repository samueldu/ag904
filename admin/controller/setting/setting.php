...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_parcelamento'] = $this->language->get('text_parcelamento');
		...
		if (isset($this->request->post['config_parcelamento_nparcelas'])) {
			$data['config_parcelamento_nparcelas'] = $this->request->post['config_parcelamento_nparcelas'];
		} else {
			$data['config_parcelamento_nparcelas'] = $this->config->get('config_parcelamento_nparcelas');
		}

		if (isset($this->request->post['config_parcelamento_juros'])) {
			$data['config_parcelamento_juros'] = $this->request->post['config_parcelamento_juros'];
		} else {
			$data['config_parcelamento_juros'] = $this->config->get('config_parcelamento_juros');
		}

		if (isset($this->request->post['config_parcelamento_minima'])) {
			$data['config_parcelamento_minima'] = $this->request->post['config_parcelamento_minima'];
		} else {
			$data['config_parcelamento_minima'] = $this->config->get('config_parcelamento_minima');
		}
