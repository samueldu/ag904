...
class ControllerSettingStore extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->load->controller('setting/client/copyBaseSite',$this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_setting_store->editStore($this->request->get['store_id'], $this->request->post,$this->request->get['id_client']);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $store_id) {
				...
				$this->model_setting_store->deleteStore($store_id,$id_client);
	...
	protected function getList() {
        ...
        if(ID_CLIENT == 0)
        {
            ...
            */
            ...
            $results = $this->model_setting_store->getStoresAdmin();
            ...
            foreach ($results as $result) {
                $data['stores'][] = array(
                    ...
                    'name'     => $result['name'],
                    'url'      => $result['url'],
                    'edit'     => $this->url->link('setting/store/edit', 'token=' . $this->session->data['token'] . '&store_id=' . $result['store_id'].'&id_client=' . $result['id_client'], 'SSL')
                );
            }
        ...
        else
        {
            ...
            foreach ($results as $result) {
                $data['stores'][] = array(
                    ...
                    'name'     => $result['name'],
                    'url'      => $result['url'],
                    'edit'     => $this->url->link('setting/store/edit', 'token=' . $this->session->data['token'] . '&store_id=' . $result['store_id'].'&id_client=' . ID_CLIENT, 'SSL')
                );
            }
        }
        ...
        if(ID_CLIENT == 0)
		$this->response->setOutput($this->load->view('setting/store_list_adm.tpl', $data));
        else
	...
	public function getForm() {
        ...
        $data['entry_url_dev'] = $this->language->get('entry_url_dev');
        $data['entry_ssl_dev'] = $this->language->get('entry_ssl_dev');
        $data['entry_path'] = $this->language->get('entry_path');
        $data['entry_path_dev'] = $this->language->get('entry_path_dev');
        ...
        if (isset($this->error['url_dev'])) {
            $data['error_url_dev'] = $this->error['url_dev'];
        } else {
            $data['error_url_dev'] = '';
        }
		...
		if (isset($this->request->get['store_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			...
			$store_info = $this->model_setting_setting->getSetting('config', $this->request->get['store_id'],$this->request->get['id_client']);
		}
		...
		if (isset($this->request->get['id_client'])) {
			$data['id_client'] = $this->request->get['id_client'];
		} else {
			$data['id_client'] = '';
		}
        ...
        if (isset($this->request->post['config_url_dev'])) {
            $data['config_url_dev'] = $this->request->post['config_url_dev'];
        } elseif (isset($store_info['config_url_dev'])) {
            $data['config_url_dev'] = $store_info['config_url_dev'];
        } else {
            $data['config_url_dev'] = '';
        }

        if (isset($this->request->post['config_path_dev'])) {
            $data['config_path_dev'] = $this->request->post['config_path_dev'];
        } elseif (isset($store_info['config_path_dev'])) {
            $data['config_path_dev'] = $store_info['config_path_dev'];
        } else {
            $data['config_path_dev'] = '';
        }

        if (isset($this->request->post['config_path'])) {
            $data['config_path'] = $this->request->post['config_path'];
        } elseif (isset($store_info['config_path'])) {
        ...
        if (isset($this->request->post['config_ssl_dev'])) {
            $data['config_ssl_dev'] = $this->request->post['config_ssl_dev'];
        } elseif (isset($store_info['config_ssl_dev'])) {
            $data['config_ssl_dev'] = $store_info['config_ssl_dev'];
        } else {
            $data['config_ssl_dev'] = '';
        }
	...
	protected function validateForm() {
		...
		if (!$this->request->post['config_prod_url']) {
