...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['badges'] = $this->model_catalog_product->getBadge();

		if (isset($this->request->post['product_badges'])) {
			$data['product_badges'] = $this->request->post['product_badges'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_badges'] = $this->model_catalog_product->getProductBadge($this->request->get['product_id']);
		} else {
			$data['product_badges'] = array();
		}
