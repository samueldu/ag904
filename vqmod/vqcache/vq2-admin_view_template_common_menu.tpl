...
<ul id="menu">
  ...
  <li id="marketing-fb"><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
...
?>
      ...
      <li id="system-local-fb"><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <?php if($ob_user->hasPermission('access','localisation/badge')) { ?><li><a href="<?php echo $badge; ?>"><?php echo $text_badge; ?></a></li> <?php }?>
  ...
  <li id="portfolio"><a class="parent"><i class="fa fa-folder-open fa-fw"></i> <span><?php echo $text_portfolios; ?></span></a>
    <ul>
  ...
  <li id="simple-blog"><a class="parent"><i class="fa fa-comments fa-fw"></i> <span><?php echo $text_simple_blogs; ?></span></a>
    <ul>
