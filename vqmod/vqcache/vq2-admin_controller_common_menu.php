...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_portfolios'] = $this->language->get('text_portfolios');
		$data['text_portfolio_author'] = $this->language->get('text_portfolio_author');
		$data['text_portfolio_images'] = $this->language->get('text_portfolio_images');
		$data['text_portfolio_category'] = $this->language->get('text_portfolio_category');
		$data['text_portfolio_article'] = $this->language->get('text_portfolio_article');
		$data['text_portfolio_article_comment'] = $this->language->get('text_portfolio_article_comment');
		$data['text_portfolio_view_report'] = $this->language->get('text_portfolio_view_report');
		$data['text_portfolio_setting'] = $this->language->get('text_portfolio_setting');
		$data['text_portfolio_general_setting'] = $this->language->get('text_portfolio_general_setting');
		$data['text_portfolio_category_setting'] = $this->language->get('text_portfolio_category_setting');
		...
		$data['text_simple_blog_images'] = $this->language->get('text_simple_blog_images');
		...
		$data['portfolio_author'] = $this->url->link('portfolio/author', 'token=' . $this->session->data['token'], 'SSL');
		$data['portfolio_images'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'].'&type_id=2', 'SSL');
		$data['portfolio_category'] = $this->url->link('portfolio/category', 'token=' . $this->session->data['token'], 'SSL');
		$data['portfolio_article'] = $this->url->link('portfolio/article', 'token=' . $this->session->data['token'], 'SSL');
		$data['portfolio_comment'] = $this->url->link('portfolio/comment', 'token=' . $this->session->data['token'], 'SSL');
		$data['portfolio_general_setting'] = $this->url->link('module/portfolio', 'token=' . $this->session->data['token'], 'SSL');
		$data['portfolio_category_setting'] = $this->url->link('module/portfolio_category', 'token=' . $this->session->data['token'], 'SSL');
		$data['portfolio_view_report'] = $this->url->link('portfolio/report', 'token=' . $this->session->data['token'], 'SSL');

		$data['simple_blog_author'] = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'], 'SSL');
		$data['simple_blog_images'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'].'&type_id=3', 'SSL');
		...
		$data['user_grou_id'] = $this->user->getGroupId();
		...
		$data['badge'] = $this->url->link('localisation/badge', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['client'] = $this->url->link('setting/client', 'token=' . $this->session->data['token'], 'SSL');
		// contatos
		$data['contactus'] = $this->url->link('module/contact', 'token=' . $this->session->data['token'], 'SSL');
		...
		if(RODANDO_NO_CORE==0)
			return $this->load->view('common/menu.tpl', $data);
		else
			return $this->load->view('common/menu_core.tpl', $data);
	}
}