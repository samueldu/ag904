...
function modification($filename) {
	...
	if (!defined('DIR_CATALOG')) {
		...
		$file = DIR_MODIFICATION .  substr($filename, strlen(BASE_CORE));
	}
	...
	if(substr_count($filename,".tpl") and !substr_count($filename,"admin"))
	{
		$file = DIR_MODIFICATION .substr($filename, strlen(BASE_DIR));
	}
